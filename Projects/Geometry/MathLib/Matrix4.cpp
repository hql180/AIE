...
Vector4 Matrix4::operator*(Vector4 & rhs)
{
	...
	temp = Vector4( m[0][0] * rhs.m_x + m[0][1] * rhs.m_y + m[0][2] * rhs.m_z + m[0][3] * rhs.m_w,
					m[1][0] * rhs.m_x + m[1][1] * rhs.m_y + m[1][2] * rhs.m_z+ m[1][3] * rhs.m_w,
					m[2][0] * rhs.m_x + m[2][1] * rhs.m_y + m[2][2] * rhs.m_z+ m[2][3] * rhs.m_w,
					m[3][0] * rhs.m_x + m[3][1] * rhs.m_y + m[3][2] * rhs.m_z + m[3][3] * rhs.m_w);
